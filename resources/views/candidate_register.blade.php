...
<form action="{{route("candidate_register_store")}}" method="POST" >
  @csrf
  <h2>Register </h2>
...
<a href="{{"candidate_login"}}" class="login" style="position:absolute;bottom:30px;right:30px;text-decoration:none;color:#eee">have an account ?</a>
